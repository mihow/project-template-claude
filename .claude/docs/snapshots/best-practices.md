...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#651016001725001d04081509004b060a08) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#c8bdbbadba88e6aba7a5) is false. run the tests after implementing”* |
