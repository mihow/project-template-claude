...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#f386809681b3968b929e839f96dd909c9e) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#4035332532006e232f2d) is false. run the tests after implementing”* |
